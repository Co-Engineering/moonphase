...
curl -fsSL https://raw.githubusercontent.com/Co-Engineering/moonphase/main/scripts/install-app.sh \
    | MOONPHASE_CHANNEL=v0.10.14 sh
```

```powershell
$env:MOONPHASE_CHANNEL = 'v0.10.14'; irm https://raw.githubusercontent.com/Co-Engineering/moonphase/main/scripts/install-app.ps1 | iex
```
