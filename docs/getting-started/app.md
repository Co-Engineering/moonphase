...
curl -fsSL https://raw.githubusercontent.com/Co-Engineering/moonphase/main/scripts/install-app.sh \
    | MOONPHASE_CHANNEL=v0.10.9 sh
```

```powershell
$env:MOONPHASE_CHANNEL = 'v0.10.9'; irm https://raw.githubusercontent.com/Co-Engineering/moonphase/main/scripts/install-app.ps1 | iex
```
