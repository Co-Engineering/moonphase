...
curl -fsSL https://raw.githubusercontent.com/Co-Engineering/moonphase/main/scripts/install-app.sh \
    | MOONPHASE_CHANNEL=v0.10.13 sh
```

```powershell
$env:MOONPHASE_CHANNEL = 'v0.10.13'; irm https://raw.githubusercontent.com/Co-Engineering/moonphase/main/scripts/install-app.ps1 | iex
```
